			...
			<div className='flex flex-row items-center justify-around flex-wrap gap-2'>
				{tipPercentages.map((percentage, index) => (
					<button
						...
						className={`noborder flex items-center text-sm border border-slate-800 bg-gradient-to-b from-slate-500 to-slate-800 hover:from-slate-to-slate-800 text-white font-bold py-2 px-3 rounded ${
							selectedTip === percentage ? 'border border-slate-800 bg-gradient-to-b from-slate-400 to-slate-400 hover:from-slate-to-slate-800 ' : ''
						}`}>

	...
	return (
		<div>
			...
			<div className='mt-5 flex flex-row flex-wrap items-center justify-around'>
				<button
					onClick={handleCons}
					className='noborder flex my-2 items-center text-sm border border-slate-800 bg-gradient-to-b from-slate-500 to-slate-800 hover:from-slate-to-slate-800 text-white hover:text-white font-bold py-2 px-4 rounded'>
					Consumidor Final
				</button>
				<button
					onClick={handleFactA}
